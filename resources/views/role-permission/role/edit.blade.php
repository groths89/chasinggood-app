        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="max-w-md p-6 mx-auto bg-white rounded-lg shadow-md" action="{{ url('roles/' . $role->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        
                        <h2 class="mb-6 text-2xl font-bold text-center">Edit Role</h2>
...
{{--                         <div class="mb-4">
                        ...
                        <button type="submit" href="{{ url('roles') }}" class="w-full py-2 font-bold text-white bg-blue-500 rounded-lg hover:bg-blue-700">Update</button>
                    </form>                   
                </div>
            </div>
        </div>
