        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('super-admin')
                        <x-nav-link :href="route('features.dashboard')" :active="request()->routeIs('features.dashboard')" wire:navigate>
                            {{ __('Features') }}
                        </x-nav-link>
                        <x-nav-link :href="route('pulse.dashboard')" :active="request()->routeIs('pulse.dashboard')" wire:navigate>
                            {{ __('Pulse') }}
                        </x-nav-link>
                    ...
                    @endhasanyrole
                    @hasanyrole('super-admin|administrator|volunteer')
                        <x-nav-link :href="route('nominations.index')" :active="request()->routeIs('nominations.index')" wire:navigate>
                            {{ __('Nominations') }}
                        </x-nav-link>                         
                    @endhasanyrole
                </div>
